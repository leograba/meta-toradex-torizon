...
const FeatureList: FeatureItem[] = [
  {
    ...
    description: (
      <>
        ...
        containerized applications on embedded Linux devices with ease.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        ...
        devices stay up-to-date with the latest features and security patches.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        ...
        Synaptics, Renesas, and Intel platforms.
      </>
    ),
  },
];
